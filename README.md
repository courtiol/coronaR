...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-04-25.xlsx!
...
#>  1 Afghan… AF    Asia      2019-12-31  2020-04-25           0            0
#>  2 Afghan… AF    Asia      2020-01-01  2020-04-25           0            0
#>  3 Afghan… AF    Asia      2020-01-02  2020-04-25           0            0
#>  4 Afghan… AF    Asia      2020-01-03  2020-04-25           0            0
#>  5 Afghan… AF    Asia      2020-01-04  2020-04-25           0            0
#>  6 Afghan… AF    Asia      2020-01-05  2020-04-25           0            0
#>  7 Afghan… AF    Asia      2020-01-06  2020-04-25           0            0
#>  8 Afghan… AF    Asia      2020-01-07  2020-04-25           0            0
#>  9 Afghan… AF    Asia      2020-01-08  2020-04-25           0            0
#> 10 Afghan… AF    Asia      2020-01-09  2020-04-25           0            0
#> # … with 12,996 more rows, and 2 more variables: deaths_cumul <dbl>,
...
www.worldometers.com to figure this out):
...
``` r
str(full_data)
#> tibble [10,090 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:10090] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:10090], format: "2020-04-25" "2020-04-24" ...
#>  $ date_report_last                : Date[1:10090], format: "2020-04-25" "2020-04-25" ...
#>  $ cases                           : num [1:10090] 70 105 84 61 35 88 63 51 10 70 ...
#>  $ deaths_daily                    : num [1:10090] 1 2 4 1 2 3 0 1 4 2 ...
#>  $ deaths_cumul                    : num [1:10090] 43 42 40 36 35 33 30 30 29 25 ...
#>  $ date_first_10_cumul_deaths      : Date[1:10090], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:10090] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:10090] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:10090] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:10090] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:10090] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:10090] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:10090] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:10090] 17 16 15 14 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:10090] 0.153 0.306 0.611 0.153 0.306 ...
#>  $ extra_mortality_cumul_country   : num [1:10090] 0.289 0.297 0.296 0.275 0.284 ...
#>  $ country_weight                  : num [1:10090] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:10090] 0.13 0.26 0.521 0.13 0.26 ...
#>  $ extra_mortality_cumul_world     : num [1:10090] 0.246 0.253 0.252 0.234 0.242 ...
#>  $ extra_mortality                 : num [1:10090] 0.611 0.611 0.611 0.611 0.611 ...
#>  $ date                            : Date[1:10090], format: "2020-04-08" "2020-04-08" ...
#>  $ days_since_date                 : 'difftime' num [1:10090] 17 17 17 17 ...
#>   ..- attr(*, "units")= chr "days"
```
...
#>  coronaR     * 0.0.0.9000 2020-04-23 [1] local         
