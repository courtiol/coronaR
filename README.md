...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-06-03.xlsx!
...
#>  1 Afghan… AF    Asia      2020-06-03  2020-06-03         759            5
#>  2 Afghan… AF    Asia      2020-06-02  2020-06-03         545            8
#>  3 Afghan… AF    Asia      2020-06-01  2020-06-03         680            8
#>  4 Afghan… AF    Asia      2020-05-31  2020-06-03         866            3
#>  5 Afghan… AF    Asia      2020-05-30  2020-06-03         623           11
#>  6 Afghan… AF    Asia      2020-05-29  2020-06-03         580            8
#>  7 Afghan… AF    Asia      2020-05-28  2020-06-03         625            7
#>  8 Afghan… AF    Asia      2020-05-27  2020-06-03         658            1
#>  9 Afghan… AF    Asia      2020-05-26  2020-06-03         591            1
#> 10 Afghan… AF    Asia      2020-05-25  2020-06-03         584            2
#> # … with 21,690 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [16,019 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:16019] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:16019], format: "2020-06-03" "2020-06-02" ...
#>  $ date_report_last                : Date[1:16019], format: "2020-06-03" "2020-06-03" ...
#>  $ cases                           : num [1:16019] 759 545 680 866 623 580 625 658 591 584 ...
#>  $ deaths_daily                    : num [1:16019] 5 8 8 3 11 8 7 1 1 2 ...
#>  $ deaths_cumul                    : num [1:16019] 270 265 257 249 246 235 227 220 219 218 ...
#>  $ date_first_10_cumul_deaths      : Date[1:16019], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:16019] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:16019] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:16019] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:16019] 57162986 57162986 57162986 57162986 57162986 ...
#>  $ total_death_day_world           : num [1:16019] 156611 156611 156611 156611 156611 ...
#>  $ country_pop                     : num [1:16019] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:16019] 7.59e+09 7.59e+09 7.59e+09 7.59e+09 7.59e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:16019] 56 55 54 53 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:16019] 0.764 1.223 1.223 0.459 1.682 ...
#>  $ extra_mortality_cumul_country   : num [1:16019] 0.7 0.699 0.689 0.679 0.684 ...
#>  $ country_weight                  : num [1:16019] 0.0049 0.0049 0.0049 0.0049 0.0049 ...
#>  $ extra_mortality_daily_world     : num [1:16019] 0.652 1.043 1.043 0.391 1.435 ...
#>  $ extra_mortality_cumul_world     : num [1:16019] 0.597 0.596 0.588 0.58 0.583 ...
#>  $ extra_mortality                 : num [1:16019] 4.89 4.89 4.89 4.89 4.89 ...
#>  $ date                            : Date[1:16019], format: "2020-05-16" "2020-05-16" ...
#>  $ days_since_date                 : 'difftime' num [1:16019] 18 18 18 18 ...
#>   ..- attr(*, "units")= chr "days"
```
