...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-13.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-13  2020-05-13         280            5
#>  2 Afghan… AF    Asia      2020-05-12  2020-05-13         285            2
#>  3 Afghan… AF    Asia      2020-05-11  2020-05-13         369            5
#>  4 Afghan… AF    Asia      2020-05-10  2020-05-13         255            6
#>  5 Afghan… AF    Asia      2020-05-09  2020-05-13         215            3
#>  6 Afghan… AF    Asia      2020-05-08  2020-05-13         171            2
#>  7 Afghan… AF    Asia      2020-05-07  2020-05-13         168            9
#>  8 Afghan… AF    Asia      2020-05-06  2020-05-13         330            5
#>  9 Afghan… AF    Asia      2020-05-05  2020-05-13         190            5
#> 10 Afghan… AF    Asia      2020-05-04  2020-05-13         235           13
#> # … with 17,281 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [12,996 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:12996] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:12996], format: "2020-05-13" "2020-05-12" ...
#>  $ date_report_last                : Date[1:12996], format: "2020-05-13" "2020-05-13" ...
#>  $ cases                           : num [1:12996] 280 285 369 255 215 171 168 330 190 235 ...
#>  $ deaths_daily                    : num [1:12996] 5 2 5 6 3 2 9 5 5 13 ...
#>  $ deaths_cumul                    : num [1:12996] 127 122 120 115 109 106 104 95 90 85 ...
#>  $ date_first_10_cumul_deaths      : Date[1:12996], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:12996] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:12996] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:12996] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:12996] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:12996] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:12996] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:12996] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:12996] 35 34 33 32 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:12996] 0.764 0.306 0.764 0.917 0.459 ...
#>  $ extra_mortality_cumul_country   : num [1:12996] 0.501 0.494 0.499 0.491 0.478 ...
#>  $ country_weight                  : num [1:12996] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:12996] 0.651 0.26 0.651 0.781 0.391 ...
#>  $ extra_mortality_cumul_world     : num [1:12996] 0.427 0.42 0.425 0.418 0.407 ...
#>  $ extra_mortality                 : num [1:12996] 1.99 1.99 1.99 1.99 1.99 ...
#>  $ date                            : Date[1:12996], format: "2020-05-04" "2020-05-04" ...
#>  $ days_since_date                 : 'difftime' num [1:12996] 9 9 9 9 ...
#>   ..- attr(*, "units")= chr "days"
```
...
#>  dplyr         0.8.99.9003 2020-05-13 [1] Github (tidyverse/dplyr@d2627f7)
...
#>  rlang         0.4.6.9000  2020-05-13 [1] Github (tidyverse/rlang@4bea875)
...
#>  vctrs         0.3.0.9000  2020-05-13 [1] Github (r-lib/vctrs@4ff6b79)    
