...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-28.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-28  2020-05-28         625            7
#>  2 Afghan… AF    Asia      2020-05-27  2020-05-28         658            1
#>  3 Afghan… AF    Asia      2020-05-26  2020-05-28         591            1
#>  4 Afghan… AF    Asia      2020-05-25  2020-05-28         584            2
#>  5 Afghan… AF    Asia      2020-05-24  2020-05-28         782           11
#>  6 Afghan… AF    Asia      2020-05-23  2020-05-28         540           12
#>  7 Afghan… AF    Asia      2020-05-22  2020-05-28         531            6
#>  8 Afghan… AF    Asia      2020-05-21  2020-05-28         492            9
#>  9 Afghan… AF    Asia      2020-05-20  2020-05-28         581            5
#> 10 Afghan… AF    Asia      2020-05-19  2020-05-28         408            4
#> # … with 20,430 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [15,155 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:15155] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:15155], format: "2020-05-28" "2020-05-27" ...
#>  $ date_report_last                : Date[1:15155], format: "2020-05-28" "2020-05-28" ...
#>  $ cases                           : num [1:15155] 625 658 591 584 782 540 531 492 581 408 ...
#>  $ deaths_daily                    : num [1:15155] 7 1 1 2 11 12 6 9 5 4 ...
#>  $ deaths_cumul                    : num [1:15155] 227 220 219 218 216 205 193 187 178 173 ...
#>  $ date_first_10_cumul_deaths      : Date[1:15155], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:15155] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:15155] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:15155] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:15155] 57162986 57162986 57162986 57162986 57162986 ...
#>  $ total_death_day_world           : num [1:15155] 156611 156611 156611 156611 156611 ...
#>  $ country_pop                     : num [1:15155] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:15155] 7.59e+09 7.59e+09 7.59e+09 7.59e+09 7.59e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:15155] 50 49 48 47 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:15155] 1.07 0.153 0.153 0.306 1.682 ...
#>  $ extra_mortality_cumul_country   : num [1:15155] 0.653 0.645 0.655 0.666 0.673 ...
#>  $ country_weight                  : num [1:15155] 0.0049 0.0049 0.0049 0.0049 0.0049 ...
#>  $ extra_mortality_daily_world     : num [1:15155] 0.913 0.13 0.13 0.261 1.435 ...
#>  $ extra_mortality_cumul_world     : num [1:15155] 0.558 0.55 0.559 0.568 0.574 ...
#>  $ extra_mortality                 : num [1:15155] 4.89 4.89 4.89 4.89 4.89 ...
#>  $ date                            : Date[1:15155], format: "2020-05-16" "2020-05-16" ...
#>  $ days_since_date                 : 'difftime' num [1:15155] 12 12 12 12 ...
#>   ..- attr(*, "units")= chr "days"
```
