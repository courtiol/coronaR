...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-04-19.xlsx!
...
#>  1 Afghan… AF    Asia      2019-12-31  2020-04-19           0            0
#>  2 Afghan… AF    Asia      2020-01-01  2020-04-19           0            0
#>  3 Afghan… AF    Asia      2020-01-02  2020-04-19           0            0
#>  4 Afghan… AF    Asia      2020-01-03  2020-04-19           0            0
#>  5 Afghan… AF    Asia      2020-01-04  2020-04-19           0            0
#>  6 Afghan… AF    Asia      2020-01-05  2020-04-19           0            0
#>  7 Afghan… AF    Asia      2020-01-06  2020-04-19           0            0
#>  8 Afghan… AF    Asia      2020-01-07  2020-04-19           0            0
#>  9 Afghan… AF    Asia      2020-01-08  2020-04-19           0            0
#> 10 Afghan… AF    Asia      2020-01-09  2020-04-19           0            0
#> # … with 11,758 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [9,230 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:9230] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:9230], format: "2020-04-19" "2020-04-18" ...
#>  $ date_report_last                : Date[1:9230], format: "2020-04-19" "2020-04-19" ...
#>  $ cases                           : num [1:9230] 63 51 10 70 49 58 52 34 37 61 ...
#>  $ deaths_daily                    : num [1:9230] 0 1 4 2 2 3 0 3 0 1 ...
#>  $ deaths_cumul                    : num [1:9230] 30 30 29 25 23 21 18 18 15 15 ...
#>  $ date_first_10_cumul_deaths      : Date[1:9230], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:9230] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:9230] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:9230] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:9230] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:9230] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:9230] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:9230] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:9230] 11 10 9 8 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:9230] 0 0.153 0.611 0.306 0.306 ...
#>  $ extra_mortality_cumul_country   : num [1:9230] 0.268 0.292 0.306 0.272 0.268 ...
#>  $ country_weight                  : num [1:9230] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:9230] 0 0.13 0.521 0.26 0.26 ...
#>  $ extra_mortality_cumul_world     : num [1:9230] 0.228 0.249 0.26 0.231 0.228 ...
#>  $ extra_mortality                 : num [1:9230] 0.611 0.611 0.611 0.611 0.611 ...
#>  $ date                            : Date[1:9230], format: "2020-04-08" "2020-04-08" ...
#>  $ days_since_date                 : 'difftime' num [1:9230] 11 11 11 11 ...
#>   ..- attr(*, "units")= chr "days"
```
