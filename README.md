...
``` r
today <- Sys.Date() - 1 ## note: you can change the date, to rebuild plots retrospectively
data_COVID <- prepare_data_ECDC(path_save_data = "~/Downloads/COVID19",
                                date_of_report = today)
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-06-05.xlsx!
...
#>  1 Afghan… AF    Asia      2020-06-05  2020-06-05         787            6
#>  2 Afghan… AF    Asia      2020-06-04  2020-06-05         758           24
#>  3 Afghan… AF    Asia      2020-06-03  2020-06-05         759            5
#>  4 Afghan… AF    Asia      2020-06-02  2020-06-05         545            8
#>  5 Afghan… AF    Asia      2020-06-01  2020-06-05         680            8
#>  6 Afghan… AF    Asia      2020-05-31  2020-06-05         866            3
#>  7 Afghan… AF    Asia      2020-05-30  2020-06-05         623           11
#>  8 Afghan… AF    Asia      2020-05-29  2020-06-05         580            8
#>  9 Afghan… AF    Asia      2020-05-28  2020-06-05         625            7
#> 10 Afghan… AF    Asia      2020-05-27  2020-06-05         658            1
#> # … with 22,110 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [16,307 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:16307] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:16307], format: "2020-06-05" "2020-06-04" ...
#>  $ date_report_last                : Date[1:16307], format: "2020-06-05" "2020-06-05" ...
#>  $ cases                           : num [1:16307] 787 758 759 545 680 866 623 580 625 658 ...
#>  $ deaths_daily                    : num [1:16307] 6 24 5 8 8 3 11 8 7 1 ...
#>  $ deaths_cumul                    : num [1:16307] 300 294 270 265 257 249 246 235 227 220 ...
#>  $ date_first_10_cumul_deaths      : Date[1:16307], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:16307] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:16307] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:16307] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:16307] 57162986 57162986 57162986 57162986 57162986 ...
#>  $ total_death_day_world           : num [1:16307] 156611 156611 156611 156611 156611 ...
#>  $ country_pop                     : num [1:16307] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:16307] 7.59e+09 7.59e+09 7.59e+09 7.59e+09 7.59e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:16307] 58 57 56 55 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:16307] 0.917 3.669 0.764 1.223 1.223 ...
#>  $ extra_mortality_cumul_country   : num [1:16307] 0.754 0.751 0.7 0.699 0.689 ...
#>  $ country_weight                  : num [1:16307] 0.0049 0.0049 0.0049 0.0049 0.0049 ...
#>  $ extra_mortality_daily_world     : num [1:16307] 0.783 3.13 0.652 1.043 1.043 ...
#>  $ extra_mortality_cumul_world     : num [1:16307] 0.643 0.641 0.597 0.596 0.588 ...
#>  $ extra_mortality                 : num [1:16307] 4.89 4.89 4.89 4.89 4.89 ...
#>  $ date                            : Date[1:16307], format: "2020-05-16" "2020-05-16" ...
#>  $ days_since_date                 : 'difftime' num [1:16307] 20 20 20 20 ...
#>   ..- attr(*, "units")= chr "days"
```
