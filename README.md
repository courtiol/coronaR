...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-08.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-08  2020-05-08         171            2
#>  2 Afghan… AF    Asia      2020-05-07  2020-05-08         168            9
#>  3 Afghan… AF    Asia      2020-05-06  2020-05-08         330            5
#>  4 Afghan… AF    Asia      2020-05-05  2020-05-08         190            5
#>  5 Afghan… AF    Asia      2020-05-04  2020-05-08         235           13
#>  6 Afghan… AF    Asia      2020-05-03  2020-05-08         134            4
#>  7 Afghan… AF    Asia      2020-05-02  2020-05-08         164            4
#>  8 Afghan… AF    Asia      2020-05-01  2020-05-08         222            4
#>  9 Afghan… AF    Asia      2020-04-30  2020-05-08         122            0
#> 10 Afghan… AF    Asia      2020-04-29  2020-05-08         124            3
#> # … with 16,235 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [12,281 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:12281] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:12281], format: "2020-05-08" "2020-05-07" ...
#>  $ date_report_last                : Date[1:12281], format: "2020-05-08" "2020-05-08" ...
#>  $ cases                           : num [1:12281] 171 168 330 190 235 134 164 222 122 124 ...
#>  $ deaths_daily                    : num [1:12281] 2 9 5 5 13 4 4 4 0 3 ...
#>  $ deaths_cumul                    : num [1:12281] 106 104 95 90 85 72 68 64 60 60 ...
#>  $ date_first_10_cumul_deaths      : Date[1:12281], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:12281] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:12281] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:12281] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:12281] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:12281] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:12281] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:12281] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:12281] 30 29 28 27 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:12281] 0.306 1.376 0.764 0.764 1.987 ...
#>  $ extra_mortality_cumul_country   : num [1:12281] 0.478 0.484 0.453 0.442 0.43 ...
#>  $ country_weight                  : num [1:12281] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:12281] 0.26 1.172 0.651 0.651 1.692 ...
#>  $ extra_mortality_cumul_world     : num [1:12281] 0.407 0.412 0.386 0.377 0.366 ...
#>  $ extra_mortality                 : num [1:12281] 1.99 1.99 1.99 1.99 1.99 ...
#>  $ date                            : Date[1:12281], format: "2020-05-04" "2020-05-04" ...
#>  $ days_since_date                 : 'difftime' num [1:12281] 4 4 4 4 ...
#>   ..- attr(*, "units")= chr "days"
```
