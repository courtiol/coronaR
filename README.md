...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-23.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-23  2020-05-23         540           12
#>  2 Afghan… AF    Asia      2020-05-22  2020-05-23         531            6
#>  3 Afghan… AF    Asia      2020-05-21  2020-05-23         492            9
#>  4 Afghan… AF    Asia      2020-05-20  2020-05-23         581            5
#>  5 Afghan… AF    Asia      2020-05-19  2020-05-23         408            4
#>  6 Afghan… AF    Asia      2020-05-18  2020-05-23         262            1
#>  7 Afghan… AF    Asia      2020-05-17  2020-05-23           0            0
#>  8 Afghan… AF    Asia      2020-05-16  2020-05-23        1063           32
#>  9 Afghan… AF    Asia      2020-05-15  2020-05-23         113            6
#> 10 Afghan… AF    Asia      2020-05-14  2020-05-23         259            3
#> # … with 19,380 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [14,435 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:14435] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:14435], format: "2020-05-23" "2020-05-22" ...
#>  $ date_report_last                : Date[1:14435], format: "2020-05-23" "2020-05-23" ...
#>  $ cases                           : num [1:14435] 540 531 492 581 408 ...
#>  $ deaths_daily                    : num [1:14435] 12 6 9 5 4 1 0 32 6 3 ...
#>  $ deaths_cumul                    : num [1:14435] 205 193 187 178 173 169 168 168 136 130 ...
#>  $ date_first_10_cumul_deaths      : Date[1:14435], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:14435] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:14435] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:14435] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:14435] 57162986 57162986 57162986 57162986 57162986 ...
#>  $ total_death_day_world           : num [1:14435] 156611 156611 156611 156611 156611 ...
#>  $ country_pop                     : num [1:14435] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:14435] 7.59e+09 7.59e+09 7.59e+09 7.59e+09 7.59e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:14435] 45 44 43 42 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:14435] 1.834 0.917 1.376 0.764 0.611 ...
#>  $ extra_mortality_cumul_country   : num [1:14435] 0.651 0.625 0.618 0.601 0.597 ...
#>  $ country_weight                  : num [1:14435] 0.0049 0.0049 0.0049 0.0049 0.0049 ...
#>  $ extra_mortality_daily_world     : num [1:14435] 1.565 0.783 1.174 0.652 0.522 ...
#>  $ extra_mortality_cumul_world     : num [1:14435] 0.556 0.533 0.528 0.513 0.509 ...
#>  $ extra_mortality                 : num [1:14435] 4.89 4.89 4.89 4.89 4.89 ...
#>  $ date                            : Date[1:14435], format: "2020-05-16" "2020-05-16" ...
#>  $ days_since_date                 : 'difftime' num [1:14435] 7 7 7 7 ...
#>   ..- attr(*, "units")= chr "days"
```
