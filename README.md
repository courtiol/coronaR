...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-11.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-11  2020-05-11         369            5
#>  2 Afghan… AF    Asia      2020-05-10  2020-05-11         255            6
#>  3 Afghan… AF    Asia      2020-05-09  2020-05-11         215            3
#>  4 Afghan… AF    Asia      2020-05-08  2020-05-11         171            2
#>  5 Afghan… AF    Asia      2020-05-07  2020-05-11         168            9
#>  6 Afghan… AF    Asia      2020-05-06  2020-05-11         330            5
#>  7 Afghan… AF    Asia      2020-05-05  2020-05-11         190            5
#>  8 Afghan… AF    Asia      2020-05-04  2020-05-11         235           13
#>  9 Afghan… AF    Asia      2020-05-03  2020-05-11         134            4
#> 10 Afghan… AF    Asia      2020-05-02  2020-05-11         164            4
#> # … with 16,862 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [12,710 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:12710] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:12710], format: "2020-05-11" "2020-05-10" ...
#>  $ date_report_last                : Date[1:12710], format: "2020-05-11" "2020-05-11" ...
#>  $ cases                           : num [1:12710] 369 255 215 171 168 330 190 235 134 164 ...
#>  $ deaths_daily                    : num [1:12710] 5 6 3 2 9 5 5 13 4 4 ...
#>  $ deaths_cumul                    : num [1:12710] 120 115 109 106 104 95 90 85 72 68 ...
#>  $ date_first_10_cumul_deaths      : Date[1:12710], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:12710] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:12710] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:12710] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:12710] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:12710] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:12710] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:12710] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:12710] 33 32 31 30 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:12710] 0.764 0.917 0.459 0.306 1.376 ...
#>  $ extra_mortality_cumul_country   : num [1:12710] 0.499 0.491 0.478 0.478 0.484 ...
#>  $ country_weight                  : num [1:12710] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:12710] 0.651 0.781 0.391 0.26 1.172 ...
#>  $ extra_mortality_cumul_world     : num [1:12710] 0.425 0.418 0.407 0.407 0.412 ...
#>  $ extra_mortality                 : num [1:12710] 1.99 1.99 1.99 1.99 1.99 ...
#>  $ date                            : Date[1:12710], format: "2020-05-04" "2020-05-04" ...
#>  $ days_since_date                 : 'difftime' num [1:12710] 7 7 7 7 ...
#>   ..- attr(*, "units")= chr "days"
```
