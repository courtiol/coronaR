...
#> The source of the COVID data have been stored in~/Downloads/COVID19/COVID-19-geographic-disbtribution-worldwide-2020-05-09.xlsx!
...
#>  1 Afghan… AF    Asia      2020-05-09  2020-05-09         215            3
#>  2 Afghan… AF    Asia      2020-05-08  2020-05-09         171            2
#>  3 Afghan… AF    Asia      2020-05-07  2020-05-09         168            9
#>  4 Afghan… AF    Asia      2020-05-06  2020-05-09         330            5
#>  5 Afghan… AF    Asia      2020-05-05  2020-05-09         190            5
#>  6 Afghan… AF    Asia      2020-05-04  2020-05-09         235           13
#>  7 Afghan… AF    Asia      2020-05-03  2020-05-09         134            4
#>  8 Afghan… AF    Asia      2020-05-02  2020-05-09         164            4
#>  9 Afghan… AF    Asia      2020-05-01  2020-05-09         222            4
#> 10 Afghan… AF    Asia      2020-04-30  2020-05-09         122            0
#> # … with 16,444 more rows, and 2 more variables: deaths_cumul <dbl>,
...
``` r
str(full_data)
#> tibble [12,424 × 24] (S3: tbl_df/tbl/data.frame)
#>  $ country                         : chr [1:12424] "Afghanistan" "Afghanistan" "Afghanistan" "Afghanistan" ...
#>  $ continent                       : Factor w/ 5 levels "Africa","Americas",..: 3 3 3 3 3 3 3 3 3 3 ...
#>  $ date_report                     : Date[1:12424], format: "2020-05-09" "2020-05-08" ...
#>  $ date_report_last                : Date[1:12424], format: "2020-05-09" "2020-05-09" ...
#>  $ cases                           : num [1:12424] 215 171 168 330 190 235 134 164 222 122 ...
#>  $ deaths_daily                    : num [1:12424] 3 2 9 5 5 13 4 4 4 0 ...
#>  $ deaths_cumul                    : num [1:12424] 109 106 104 95 90 85 72 68 64 60 ...
#>  $ date_first_10_cumul_deaths      : Date[1:12424], format: "2020-04-08" "2020-04-08" ...
#>  $ year_mortality                  : num [1:12424] 2018 2018 2018 2018 2018 ...
#>  $ total_death_year                : num [1:12424] 238758 238758 238758 238758 238758 ...
#>  $ total_death_day                 : num [1:12424] 654 654 654 654 654 ...
#>  $ total_death_year_world          : num [1:12424] 56650926 56650926 56650926 56650926 56650926 ...
#>  $ total_death_day_world           : num [1:12424] 155208 155208 155208 155208 155208 ...
#>  $ country_pop                     : num [1:12424] 37172386 37172386 37172386 37172386 37172386 ...
#>  $ world_pop                       : num [1:12424] 7.51e+09 7.51e+09 7.51e+09 7.51e+09 7.51e+09 ...
#>  $ days_since_first_10_cumul_deaths: 'difftime' num [1:12424] 31 30 29 28 ...
#>   ..- attr(*, "units")= chr "days"
#>  $ extra_mortality_daily_country   : num [1:12424] 0.459 0.306 1.376 0.764 0.764 ...
#>  $ extra_mortality_cumul_country   : num [1:12424] 0.478 0.478 0.484 0.453 0.442 ...
#>  $ country_weight                  : num [1:12424] 0.00495 0.00495 0.00495 0.00495 0.00495 ...
#>  $ extra_mortality_daily_world     : num [1:12424] 0.391 0.26 1.172 0.651 0.651 ...
#>  $ extra_mortality_cumul_world     : num [1:12424] 0.407 0.407 0.412 0.386 0.377 ...
#>  $ extra_mortality                 : num [1:12424] 1.99 1.99 1.99 1.99 1.99 ...
#>  $ date                            : Date[1:12424], format: "2020-05-04" "2020-05-04" ...
#>  $ days_since_date                 : 'difftime' num [1:12424] 5 5 5 5 ...
#>   ..- attr(*, "units")= chr "days"
```
